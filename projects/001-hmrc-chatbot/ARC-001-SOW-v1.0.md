...
9. **Comprehensive Testing**
   - Unit testing (≥80% code coverage, 100% coverage for critical paths)
...
| **Test Strategy** | Unit, integration, E2E, accessibility, AI accuracy, bias, performance, security testing approach | PDF/Markdown | Week 8 | Approved by HMRC QA Lead. Coverage targets defined (≥80% unit, 100% critical paths). |

### 4.2 Development Phase Deliverables (Months 3-8, Ongoing)

| Deliverable | Description | Format | Due Date | Acceptance Criteria |
|-------------|-------------|--------|----------|---------------------|
| **Source Code** | All application code (backend, frontend, AI pipeline) | Git repository (GitHub or AWS CodeCommit) | Ongoing | Code review approved (2 reviewers). Passes CI/CD quality gates. ≥80% unit test coverage. |
...
| **Unit Tests** | Automated unit tests for all components | Code (pytest, Jest, Go test) | Ongoing | ≥80% code coverage. 100% coverage for critical paths (auth, AI generation, HMRC integration). |
...
| **M2: Development Milestone (50% Complete)** | Week 20 | Core ChatBot, RAG pipeline, HMRC integrations working in dev environment | Demo to stakeholders. Unit tests ≥80% coverage. Integration tests passing. | 20% (upon Sprint 4 completion) |
...
|------|-------------------|------------|------------|
| **Solution Architect** | 10+ years, AWS Certified Solutions Architect Professional, UK Gov experience | ≥50% dedicated | YES |
| **Security Architect** | 8+ years, CISSP or equivalent, NCSC Cloud Security Principles expertise | ≥25% dedicated | YES |
| **AI/ML Lead** | 8+ years, AWS Certified ML Specialty, RAG architecture experience | ≥75% dedicated | YES |
| **Technical Lead / Engineering Manager** | 8+ years, team leadership experience | ≥75% dedicated | YES |
...
| **QA Lead** | 5+ years, test automation, accessibility testing | ≥50% dedicated | YES |
| **QA Engineers** | 3+ years, test automation (Python/JavaScript) | 2 FTE | YES |
| **Accessibility Specialist** | WCAG 2.2 AA certified, assistive technology testing | ≥25% dedicated | YES |
| **Content Designer** | Plain English writing, GOV.UK style guide experience | ≥25% dedicated | YES |
| **Technical Writer** | API documentation, technical writing for developers | ≥50% dedicated | YES |
| **Scrum Master / Delivery Manager** | Agile delivery, stakeholder management | ≥50% dedicated | PREFERRED |
...
- **Team Composition and Depth (8 points)**
  - 7-8: Well-structured team meeting all role requirements. Good onshore/offshore mix (≥50% onshore). Depth in AI/ML, security, accessibility.
...
| M2: Development Milestone (Week 20) | 20% | £[X] | Core ChatBot, RAG pipeline, HMRC integrations demonstrated in dev environment. Unit tests ≥80% coverage. |
...
- **Code Acceptance**: Passes code review (2 reviewers). Passes CI/CD quality gates (unit tests ≥80% coverage, SAST/dependency scans pass). Deployable to staging environment.
...
|---------|------|--------|---------|
| 0.1 | 2025-10-07 | HMRC EA Team | Initial draft |
| 0.2 | 2025-10-10 | HMRC Procurement | Stakeholder feedback |
| 1.0 | 2025-10-14 | HMRC Procurement Lead | Issued to vendors |
